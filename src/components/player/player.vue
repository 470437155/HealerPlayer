<template>
  <div class="player" v-show="playlist.length>0">
    ...
    >
      ...
      <div class="bottom">
        <div class="detail">
          <span class="singer" @click.stop="selectSinger(currentSong.singermid)">歌手</span>
          <span class="singer">|</span>
          <span class="singer" @click.stop="selectAlbum(currentSong)">专辑</span>
          <span class="singer">|</span>
          <span class="singer" @click.stop="showComment">评论</span>
        </div>
...
export default {
  ...
  methods: {
    ...
    selectAlbum(item){
      this.$router.push({
        path: `/singeralbum/${item.albummid}`
      })
      this.setFullScreen(false)
    },
    back () {
